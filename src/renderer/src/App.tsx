...
const UserFlowReportScreen = lazy(() => import('./screens/user-flow-report').then(m => ({ default: m.UserFlowReportScreen })))
        ...
        <AppShell>
          <Suspense fallback={<PageFallback />}>
            <Routes>
              ...
              <Route path="/user-flow" element={<UserFlowReportScreen />} />
